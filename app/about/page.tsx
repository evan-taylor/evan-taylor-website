  ...
  const timeline = [
    {
      ...
      description: "Currently pursuing Bachelor's in Computer Science and a minor in Entrepreneurship."
    },
    {
      year: "2024",
      title: "Clark College",
      description: "Completed computer science foundation coursework in Python, C, HTML/CSS, and JavaScript. All credits transferred to Cal Poly."
    },
    {
      year: "2024",
      title: "Hockinson High School",
      description: "Graduated in 2024. I was a captain of the boys varsity swim team and member of the varsity golf team. Active in Future Business Leaders of America and National Honor Society."
    },
    {
      year: "2023",
      title: "Taylored Instruction LLC",
      description: "Founded American Red Cross and AHA Training Site. Teaching CPR & Lifeguard certification courses."
    }
  ];
      ...
      <main className="main-section">
        ...
        <div className="now-section">
          ...
          <p>
            ...
            and founder of a Red Cross Training Site, I&apos;ve learned the importance of combining 
            technical skills with strong communication and leadership abilities.
          </p>
        </div>
          ...
          {timeline.map((item, index) => (
            <div key={index} style={{marginBottom: '40px'}}>
              <div style={{display: 'flex', justifyContent: 'space-between', alignItems: 'baseline', marginBottom: '8px'}}>
                <h3 style={{fontSize: '16px', fontWeight: '500', color: 'var(--foreground)'}}>{item.title}</h3>
                <span style={{color: 'var(--muted)', fontSize: '14px'}}>{item.year}</span>
              </div>
        ...
        <div className="now-section">
          ...
          <p>
            ...
            managing operations, and building relationships with clients and partners.
          </p>
        </div>
